    ...
    <strong>
      <Button
        onClick={() => {
          ...
          navigate('/dashboardAdmin/Update_HTML');
        }}
        variant='contained'
        color='primary'
        size='small'>
          ...
          <Typography
            ...
            <Button
              onClick={() => {
                ...
                axios
                  .delete(
                    `http://localhost:8080/api/getHTMLG/${params.row.title}`
                  )
                  .then((res) => {
                    console.log(res);
...
const Index = () => {
  ...
  return (
    <Box m='20px'>
      <Header title='HTML GUIDES' subtitle='Managing the HTML Guides' />
      <Box
        m='40px 0 0 0'
        height='65vh'
        sx={{
